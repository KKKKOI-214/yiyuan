  ...
  <div :style='{"padding":"20px 30px 30px 0","fontSize":"14px","color":"#666","background":"#f6f6f6"}'>
    ...
    >  
     <el-row>
        ...
        <el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-if="flag=='yisheng'"  label="医生性别" prop="yishengxingbie">
        ...
        <el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}'   v-if="flag=='yisheng'"  label="联系手机" prop="lianxishouji">
...
export default {
  ...
  methods: {
    ...
    onUpdateHandler() {
      ...
      if( 'yisheng' ==this.flag && this.ruleForm.lianxishouji&&(!isMobile(this.ruleForm.lianxishouji))){
