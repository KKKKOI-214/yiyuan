	...
	<div class="addEdit-block" :style='{"padding":"30px 0","fontSize":"14px","color":"#999","background":"#f6f6f6"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="select" v-if="type!='info'"  label="挂号数" prop="yuhao">
					<el-select :disabled="ro.yuhao" v-model="ruleForm.yuhao" placeholder="请选择挂号数" >
						<el-option
							v-for="(item,index) in yuhaoOptions"
							v-bind:key="index"
							:label="item"
							:value="item">
						</el-option>
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else class="input" label="挂号数" prop="yuhao">
					<el-input v-model="ruleForm.yuhao"
...
var objcross = this.$storage.getObj('crossObj');
      ...
      if(objcross!=null) {
		  if(!this.ruleForm.yuhao){
			  this.$message.error("挂号数不能为空");
			  return
		  }
	      objcross.yuhao = objcross.yuhao - this.ruleForm.yuhao
	      if(objcross.yuhao<0){
