	...
	<div class="addEdit-block" :style='{"padding":"30px 0","fontSize":"14px","color":"#999","background":"#f6f6f6"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'"  label="医生性别" prop="yishengxingbie">
					<el-input v-model="ruleForm.yishengxingbie" placeholder="医生性别" clearable  :readonly="ro.yishengxingbie"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else class="input" label="医生性别" prop="yishengxingbie">
					<el-input v-model="ruleForm.yishengxingbie" placeholder="医生性别" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'"  label="联系手机" prop="lianxishouji">
					<el-input v-model="ruleForm.lianxishouji" placeholder="联系手机" clearable  :readonly="ro.lianxishouji"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else class="input" label="联系手机" prop="lianxishouji">
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="select" v-if="type!='info'"  label="职位" prop="zhiwei">
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'"  label="余号" prop="yuhao">
					<el-input v-model.number="ruleForm.yuhao" placeholder="余号" clearable  :readonly="ro.yuhao"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else class="input" label="余号" prop="yuhao">
					<el-input v-model="ruleForm.yuhao" placeholder="余号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="select" v-if="type!='info'"  label="科室名称" prop="keshimingcheng">
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'"  label="擅长类型" prop="shanzhangleixing">
					<el-input v-model="ruleForm.shanzhangleixing" placeholder="擅长类型" clearable  :readonly="ro.shanzhangleixing"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else class="input" label="擅长类型" prop="shanzhangleixing">
					<el-input v-model="ruleForm.shanzhangleixing" placeholder="擅长类型" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'"  label="就诊时间" prop="jiuzhenshijian">
					<el-input v-model="ruleForm.jiuzhenshijian" placeholder="就诊时间" clearable  :readonly="ro.jiuzhenshijian"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else class="input" label="就诊时间" prop="jiuzhenshijian">
					<el-input v-model="ruleForm.jiuzhenshijian" placeholder="就诊时间" readonly></el-input>
				</el-form-item>
			</template>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="textarea" v-if="type!='info'" label="医生简介" prop="yishengjianjie">
					<el-input
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else-if="ruleForm.yishengjianjie" label="医生简介" prop="yishengjianjie">
					<span :style='{"fontSize":"14px","lineHeight":"40px","color":"inherit","background":"none","fontWeight":"500","display":"inline-block"}'>{{ruleForm.yishengjianjie}}</span>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-if="type!='info'"  label="荣誉信息" prop="rongyuxinxi">
					<editor 
						style="min-width: 200px; max-width: 600px;"
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else-if="ruleForm.rongyuxinxi" label="荣誉信息" prop="rongyuxinxi">
                    <span :style='{"fontSize":"14px","lineHeight":"40px","color":"inherit","background":"none","fontWeight":"500","display":"inline-block"}' v-html="ruleForm.rongyuxinxi"></span>
                </el-form-item>
...
export default {
		...
		init(id,type) {
			...
			this.$http({
				...
				if (data && data.code === 0) {
					...
					if(((json.yishengxingbie!=''&&json.yishengxingbie) || json.yishengxingbie==0) && this.$storage.get("role")!="管理员"){
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.rongyuxinxi = this.ruleForm.rongyuxinxi.replace(reg,'../../../python96xeny5v/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
