...
<style lang="scss" scoped>
	...
	.scrollbar-wrapper-open .el-menu-vertical-2 /deep/ .el-submenu.other .el-menu {
				...
				margin: 0px 16px 0;
				overflow: hidden;
				background: rgba(5, 34, 59, 1) no-repeat 20px top;
				width: calc(100% - 32px);
				font-size: inherit;
			}
