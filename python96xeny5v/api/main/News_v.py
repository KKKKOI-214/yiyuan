...
# 注册接口
@main_bp.route("/python96xeny5v/news/register", methods=['POST'])
def python96xeny5v_news_register():
...
# 登录接口
@main_bp.route("/python96xeny5v/news/login", methods=['GET','POST'])
def python96xeny5v_news_login():
...
# 登出接口
@main_bp.route("/python96xeny5v/news/logout", methods=['POST'])
def python96xeny5v_news_logout():
    if request.method == 'POST':
        msg = {
            "msg": "退出成功",
            "code": 0
...
# 重置密码接口
@main_bp.route("/python96xeny5v/news/resetPass", methods=['POST'])
def python96xeny5v_news_resetpass():
    '''
    '''
    if request.method == 'POST':
...
# 获取会话信息接口
@main_bp.route("/python96xeny5v/news/session", methods=['GET'])
def python96xeny5v_news_session():
    '''
    '''
...
# 分类接口（后端）
@main_bp.route("/python96xeny5v/news/page", methods=['GET'])
def python96xeny5v_news_page():
    '''
    '''
    if request.method == 'GET':
...
# 排序接口
@main_bp.route("/python96xeny5v/news/autoSort", methods=['GET'])
def python96xeny5v_news_autosort():
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, "msg": "success",  "data":{"currPage":1,"totalPage":1,"total":1,"pageSize":10,"list":[]}}
...
#查询单条数据
@main_bp.route("/python96xeny5v/news/query", methods=['GET'])
def python96xeny5v_news_query():
    if request.method == 'GET':
        msg = {"code": normal_code, "msg": "success",  "data":{}}
        req_dict = session.get("req_dict")
...
# 分页接口（前端）
@main_bp.route("/python96xeny5v/news/list", methods=['GET'])
def python96xeny5v_news_list():
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, "msg": "success",  "data":{"currPage":1,"totalPage":1,"total":1,"pageSize":10,"list":[]}}
...
# 保存接口（后端）
@main_bp.route("/python96xeny5v/news/save", methods=['POST'])
def python96xeny5v_news_save():
    '''
    '''
    if request.method == 'POST':
        msg = {"code": normal_code, "msg": "success", "data": {}}
...
# 添加接口（前端）
@main_bp.route("/python96xeny5v/news/add", methods=['POST'])
def python96xeny5v_news_add():
    '''
    '''
    if request.method == 'POST':
        msg = {"code": normal_code, "msg": "success", "data": {}}
...
# 踩、赞接口
@main_bp.route("/python96xeny5v/news/thumbsup/<id_>", methods=['GET'])
def python96xeny5v_news_thumbsup(id_):
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, "msg": "success", "data": {}}
...
# 获取详情信息（后端）
@main_bp.route("/python96xeny5v/news/info/<id_>", methods=['GET'])
def python96xeny5v_news_info(id_):
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, "msg": "success", "data": {}}
...
# 获取详情信息（前端）
@main_bp.route("/python96xeny5v/news/detail/<id_>", methods=['GET'])
def python96xeny5v_news_detail(id_):
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, "msg": "success", "data": {}}
...
# 更新接口
@main_bp.route("/python96xeny5v/news/update", methods=['POST'])
def python96xeny5v_news_update():
    '''
    '''
    if request.method == 'POST':
        msg = {"code": normal_code, "msg": "success", "data": {}}
...
# 删除接口
@main_bp.route("/python96xeny5v/news/delete", methods=['POST'])
def python96xeny5v_news_delete():
    '''
    '''
    if request.method == 'POST':
        msg = {"code": normal_code, "msg": "success", "data": {}}
...
# 投票接口
@main_bp.route("/python96xeny5v/news/vote/<int:id_>", methods=['POST'])
def python96xeny5v_news_vote(id_):
    '''
    '''
    if request.method == 'POST':
        msg = {"code": normal_code, "msg": "success"}
...
# 分组统计接口
@main_bp.route("/python96xeny5v/news/group/<columnName>", methods=['GET'])
def python96xeny5v_news_group(columnName):
    '''
    分组统计接口
    '''
    if request.method == 'GET':
...
# 按值统计接口
@main_bp.route("/python96xeny5v/news/value/<xColumnName>/<yColumnName>", methods=['GET'])
def python96xeny5v_news_value(xColumnName, yColumnName):
    '''
    按值统计接口,
    {
        "code": 0,
...
# 按日期统计接口
@main_bp.route("/python96xeny5v/news/value/<xColumnName>/<yColumnName>/<timeStatType>", methods=['GET'])
def python96xeny5v_news_value_riqi(xColumnName, yColumnName, timeStatType):
    '''
    按日期统计接口
    '''
    if request.method == 'GET':
...
# 按值统计（多）
@main_bp.route("/python96xeny5v/news/valueMul/<xColumnName>", methods=['GET'])
def python96xeny5v_news_valueMul(xColumnName):
...
# 按值统计（多）
@main_bp.route("/python96xeny5v/news/valueMul/<xColumnName>/<timeStatType>", methods=['GET'])
def python96xeny5v_news_valueMul_time(xColumnName,timeStatType):
...
# 推荐算法接口
@main_bp.route("/python96xeny5v/news/autoSort2", methods=['GET'])
def python96xeny5v_news_autoSort2():
    if request.method == 'GET':
...
# 统计接口
@main_bp.route("/python96xeny5v/news/remind/<columnName>/<type>", methods=['GET'])  #
def python96xeny5v_news_remind(columnName,type):
    '''
    '''
    if request.method == 'GET':
...
#分类列表
@main_bp.route("/python96xeny5v/news/lists", methods=['GET'])
def python96xeny5v_news_lists():
    if request.method == 'GET':
        msg = {"code": normal_code, "msg": "success", "data": []}
