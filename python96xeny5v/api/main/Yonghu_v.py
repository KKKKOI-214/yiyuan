...
# 注册接口
@main_bp.route("/python96xeny5v/yonghu/register", methods=['POST'])
def python96xeny5v_yonghu_register():
...
# 登录接口
@main_bp.route("/python96xeny5v/yonghu/login", methods=['GET','POST'])
def python96xeny5v_yonghu_login():
...
# 登出接口
@main_bp.route("/python96xeny5v/yonghu/logout", methods=['POST'])
def python96xeny5v_yonghu_logout():
    if request.method == 'POST':
        msg = {
            "msg": "退出成功",
            "code": 0
...
# 重置密码接口
@main_bp.route("/python96xeny5v/yonghu/resetPass", methods=['POST'])
def python96xeny5v_yonghu_resetpass():
    '''
    '''
    if request.method == 'POST':
...
# 获取会话信息接口
@main_bp.route("/python96xeny5v/yonghu/session", methods=['GET'])
def python96xeny5v_yonghu_session():
    '''
    '''
...
# 分类接口（后端）
@main_bp.route("/python96xeny5v/yonghu/page", methods=['GET'])
def python96xeny5v_yonghu_page():
    '''
    '''
    if request.method == 'GET':
...
# 排序接口
@main_bp.route("/python96xeny5v/yonghu/autoSort", methods=['GET'])
def python96xeny5v_yonghu_autosort():
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, "msg": "success",  "data":{"currPage":1,"totalPage":1,"total":1,"pageSize":10,"list":[]}}
...
#查询单条数据
@main_bp.route("/python96xeny5v/yonghu/query", methods=['GET'])
def python96xeny5v_yonghu_query():
    if request.method == 'GET':
        msg = {"code": normal_code, "msg": "success",  "data":{}}
        req_dict = session.get("req_dict")
...
# 分页接口（前端）
@main_bp.route("/python96xeny5v/yonghu/list", methods=['GET'])
def python96xeny5v_yonghu_list():
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, "msg": "success",  "data":{"currPage":1,"totalPage":1,"total":1,"pageSize":10,"list":[]}}
...
# 保存接口（后端）
@main_bp.route("/python96xeny5v/yonghu/save", methods=['POST'])
def python96xeny5v_yonghu_save():
    '''
    '''
    if request.method == 'POST':
        msg = {"code": normal_code, "msg": "success", "data": {}}
...
# 添加接口（前端）
@main_bp.route("/python96xeny5v/yonghu/add", methods=['POST'])
def python96xeny5v_yonghu_add():
    '''
    '''
    if request.method == 'POST':
        msg = {"code": normal_code, "msg": "success", "data": {}}
...
# 踩、赞接口
@main_bp.route("/python96xeny5v/yonghu/thumbsup/<id_>", methods=['GET'])
def python96xeny5v_yonghu_thumbsup(id_):
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, "msg": "success", "data": {}}
...
# 获取详情信息（后端）
@main_bp.route("/python96xeny5v/yonghu/info/<id_>", methods=['GET'])
def python96xeny5v_yonghu_info(id_):
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, "msg": "success", "data": {}}
...
# 获取详情信息（前端）
@main_bp.route("/python96xeny5v/yonghu/detail/<id_>", methods=['GET'])
def python96xeny5v_yonghu_detail(id_):
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, "msg": "success", "data": {}}
...
# 更新接口
@main_bp.route("/python96xeny5v/yonghu/update", methods=['POST'])
def python96xeny5v_yonghu_update():
    '''
    '''
    if request.method == 'POST':
        msg = {"code": normal_code, "msg": "success", "data": {}}
...
# 更新接口
@main_bp.route("/python96xeny5v/yonghu/updateMoney", methods=['POST'])
def python96xeny5v_yonghu_updateMoney():
    '''
    '''
    if request.method == 'POST':
        msg = {"code": normal_code, "msg": "success", "data": {}}
        ...
        #获取用户原有余额加上充值金额
        data = yonghu.getbyid(yonghu, yonghu, req_dict["id"])
        money = data[0]['money']
        money_ = int(money)
        addmoney=int(req_dict["addmoney"])+money_
        req_dict["money"]=str(addmoney)
        #增加余额完成
...
# 支付
@main_bp.route("/python96xeny5v/yonghu/pay/<id_>/<yid_>", methods=['POST'])
def python96xeny5v_yonghu_pay(id_,yid_):
    '''
    '''
    if request.method == 'POST':
        msg = {"code": normal_code, "msg": "success", "data": {}}
        ...
        if money_<20:
            ...
            #预约挂号支付状态修改
            data2 = yuyueguahao.getbyid(yuyueguahao, yuyueguahao, int(yid_))
            print(data2);
            data2[0]['zf'] = '已支付'
...
# 删除接口
@main_bp.route("/python96xeny5v/yonghu/delete", methods=['POST'])
def python96xeny5v_yonghu_delete():
    '''
    '''
    if request.method == 'POST':
        msg = {"code": normal_code, "msg": "success", "data": {}}
...
# 投票接口
@main_bp.route("/python96xeny5v/yonghu/vote/<int:id_>", methods=['POST'])
def python96xeny5v_yonghu_vote(id_):
    '''
    '''
    if request.method == 'POST':
        msg = {"code": normal_code, "msg": "success"}
...
# 分组统计接口
@main_bp.route("/python96xeny5v/yonghu/group/<columnName>", methods=['GET'])
def python96xeny5v_yonghu_group(columnName):
    '''
    分组统计接口
    '''
    if request.method == 'GET':
...
# 按值统计接口
@main_bp.route("/python96xeny5v/yonghu/value/<xColumnName>/<yColumnName>", methods=['GET'])
def python96xeny5v_yonghu_value(xColumnName, yColumnName):
    '''
    按值统计接口,
    {
        "code": 0,
...
# 按日期统计接口
@main_bp.route("/python96xeny5v/yonghu/value/<xColumnName>/<yColumnName>/<timeStatType>", methods=['GET'])
def python96xeny5v_yonghu_value_riqi(xColumnName, yColumnName, timeStatType):
    '''
    按日期统计接口
    '''
    if request.method == 'GET':
...
# 按值统计（多）
@main_bp.route("/python96xeny5v/yonghu/valueMul/<xColumnName>", methods=['GET'])
def python96xeny5v_yonghu_valueMul(xColumnName):
...
# 按值统计（多）
@main_bp.route("/python96xeny5v/yonghu/valueMul/<xColumnName>/<timeStatType>", methods=['GET'])
def python96xeny5v_yonghu_valueMul_time(xColumnName,timeStatType):
...
# 统计接口
@main_bp.route("/python96xeny5v/yonghu/remind/<columnName>/<type>", methods=['GET'])  #
def python96xeny5v_yonghu_remind(columnName,type):
    '''
    '''
    if request.method == 'GET':
...
#分类列表
@main_bp.route("/python96xeny5v/yonghu/lists", methods=['GET'])
def python96xeny5v_yonghu_lists():
    if request.method == 'GET':
        msg = {"code": normal_code, "msg": "success", "data": []}
