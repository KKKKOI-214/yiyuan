...
# 注册接口
@main_bp.route("/python96xeny5v/chat/register", methods=['POST'])
def python96xeny5v_chat_register():
...
# 登录接口
@main_bp.route("/python96xeny5v/chat/login", methods=['GET','POST'])
def python96xeny5v_chat_login():
...
# 登出接口
@main_bp.route("/python96xeny5v/chat/logout", methods=['POST'])
def python96xeny5v_chat_logout():
    if request.method == 'POST':
        msg = {
            "msg": "退出成功",
            "code": 0
...
# 重置密码接口
@main_bp.route("/python96xeny5v/chat/resetPass", methods=['POST'])
def python96xeny5v_chat_resetpass():
    '''
    '''
    if request.method == 'POST':
...
# 获取会话信息接口
@main_bp.route("/python96xeny5v/chat/session", methods=['GET'])
def python96xeny5v_chat_session():
    '''
    '''
...
# 分类接口（后端）
@main_bp.route("/python96xeny5v/chat/page", methods=['GET'])
def python96xeny5v_chat_page():
    '''
    '''
    if request.method == 'GET':
...
# 排序接口
@main_bp.route("/python96xeny5v/chat/autoSort", methods=['GET'])
def python96xeny5v_chat_autosort():
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, "msg": "success",  "data":{"currPage":1,"totalPage":1,"total":1,"pageSize":10,"list":[]}}
...
#查询单条数据
@main_bp.route("/python96xeny5v/chat/query", methods=['GET'])
def python96xeny5v_chat_query():
    if request.method == 'GET':
        msg = {"code": normal_code, "msg": "success",  "data":{}}
        req_dict = session.get("req_dict")
...
# 分页接口（前端）
@main_bp.route("/python96xeny5v/chat/list", methods=['GET'])
def python96xeny5v_chat_list():
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, "msg": "success",  "data":{"currPage":1,"totalPage":1,"total":1,"pageSize":10,"list":[]}}
...
# 保存接口（后端）
@main_bp.route("/python96xeny5v/chat/save", methods=['POST'])
def python96xeny5v_chat_save():
    '''
    '''
    if request.method == 'POST':
        msg = {"code": normal_code, "msg": "success", "data": {}}
...
# 添加接口（前端）
@main_bp.route("/python96xeny5v/chat/add", methods=['POST'])
def python96xeny5v_chat_add():
    '''
    '''
    if request.method == 'POST':
        msg = {"code": normal_code, "msg": "success", "data": {}}
...
# 踩、赞接口
@main_bp.route("/python96xeny5v/chat/thumbsup/<id_>", methods=['GET'])
def python96xeny5v_chat_thumbsup(id_):
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, "msg": "success", "data": {}}
...
# 获取详情信息（后端）
@main_bp.route("/python96xeny5v/chat/info/<id_>", methods=['GET'])
def python96xeny5v_chat_info(id_):
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, "msg": "success", "data": {}}
...
# 获取详情信息（前端）
@main_bp.route("/python96xeny5v/chat/detail/<id_>", methods=['GET'])
def python96xeny5v_chat_detail(id_):
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, "msg": "success", "data": {}}
...
# 更新接口
@main_bp.route("/python96xeny5v/chat/update", methods=['POST'])
def python96xeny5v_chat_update():
    '''
    '''
    if request.method == 'POST':
        msg = {"code": normal_code, "msg": "success", "data": {}}
...
# 删除接口
@main_bp.route("/python96xeny5v/chat/delete", methods=['POST'])
def python96xeny5v_chat_delete():
    '''
    '''
    if request.method == 'POST':
        msg = {"code": normal_code, "msg": "success", "data": {}}
...
# 投票接口
@main_bp.route("/python96xeny5v/chat/vote/<int:id_>", methods=['POST'])
def python96xeny5v_chat_vote(id_):
    '''
    '''
    if request.method == 'POST':
        msg = {"code": normal_code, "msg": "success"}
...
def python96xeny5v_option_chat():
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, 'data': []}
...
# 分组统计接口
@main_bp.route("/python96xeny5v/chat/group/<columnName>", methods=['GET'])
def python96xeny5v_chat_group(columnName):
    '''
    分组统计接口
    '''
    if request.method == 'GET':
...
# 按值统计接口
@main_bp.route("/python96xeny5v/chat/value/<xColumnName>/<yColumnName>", methods=['GET'])
def python96xeny5v_chat_value(xColumnName, yColumnName):
    '''
    按值统计接口,
    {
        "code": 0,
...
# 按日期统计接口
@main_bp.route("/python96xeny5v/chat/value/<xColumnName>/<yColumnName>/<timeStatType>", methods=['GET'])
def python96xeny5v_chat_value_riqi(xColumnName, yColumnName, timeStatType):
    '''
    按日期统计接口
    '''
    if request.method == 'GET':
...
# 按值统计（多）
@main_bp.route("/python96xeny5v/chat/valueMul/<xColumnName>", methods=['GET'])
def python96xeny5v_chat_valueMul(xColumnName):
...
# 按值统计（多）
@main_bp.route("/python96xeny5v/chat/valueMul/<xColumnName>/<timeStatType>", methods=['GET'])
def python96xeny5v_chat_valueMul_time(xColumnName,timeStatType):
...
# 统计接口
@main_bp.route("/python96xeny5v/chat/remind/<columnName>/<type>", methods=['GET'])  #
def python96xeny5v_chat_remind(columnName,type):
    '''
    '''
    if request.method == 'GET':
...
#分类列表
@main_bp.route("/python96xeny5v/chat/lists", methods=['GET'])
def python96xeny5v_chat_lists():
    if request.method == 'GET':
        msg = {"code": normal_code, "msg": "success", "data": []}
