...
def before_request():
    ...
    if request.method == 'GET':
        get_list = [
            "/",
            "/apidocs/",
             "/python96xeny5v/examusers/login" ,
            "/python96xeny5v/examusers/register",
            '/python96xeny5v/defaultuser/login',
            '/python96xeny5v/users/login',
        ...
        post_list = [
            '/python96xeny5v/defaultuser/register',
            '/python96xeny5v/defaultuser/login',
            '/python96xeny5v/users/register',
            '/python96xeny5v/users/login',
            "/python96xeny5v/examusers/login" ,
            "/python96xeny5v/examusers/register"
        ]  # 免认证list
