...
<div :style='{"width":"100%","padding":"30px 7% 40px","margin":"0px auto","position":"relative","background":"none"}'>
    ...
    >
          ...
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}'  label="挂号数" prop="yuhao">
            <el-select v-model="ruleForm.yuhao" placeholder="请选择挂号数" :disabled=" false  ||ro.yuhao" >
              <el-option
      ...
      <el-form-item :style='{"padding":"0","margin":"0"}'>
        <el-button :style='{"border":"0","cursor":"pointer","padding":"0","margin":"0 20px 0 0","outline":"none","color":"rgba(255, 255, 255, 1)","borderRadius":"6px","background":"#1e3c4f","width":"128px","lineHeight":"36px","fontSize":"14px","height":"36px"}'  type="primary" @click="onSubmit">确认预约</el-button>
  ...
  export default {
    ...
    // 多级联动参数
      ...
      onSubmit() {
			...
			obj.yuhao = obj.yuhao - this.ruleForm.yuhao
			if(obj.yuhao<0){
					...
					if(crossrefid && crossuserid) {
						...
						this.$http.get('yuyueguahao/list', {
							...
							if(res.data.data.total>=crossoptnum) {
								...
								obj.yuhao = parseFloat(obj.yuhao) - parseFloat(this.ruleForm.yuhao)
